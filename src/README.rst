...
following naive assumption:
   ...
   *If I remove all the stopwords, get the stems from words, sort them
   and after that these sentences become similar, they are probably
   talking about the same, or similar, subject.*
